...
@click.option('--test_mode',         help='test mode', metavar='STR',                 type=str, default="original")
...
def main(**kwargs):
    ...
    dataset_kwargs = dnnlib.EasyDict(class_name='', data_root=opts.data, split='train', multi_person=True, image_scaling=0.5, sample_obs_view=opts.sample_obs_view, fix_obs_view=opts.fix_obs_view)
    ...
    # if opts.cfg == 'THuman' or opts.cfg == 'zju_mocap' or opts.cfg == 'RenderPeople' or opts.cfg == 'HuMMan' or opts.cfg == 'MVHuman' or opts.cfg == :
